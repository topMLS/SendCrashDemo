...
public class MailSender extends Authenticator {
	...
	private String mailhost = "smtp.qq.com";//默认用gmail发送
	private String mailhostPort="465";//默认发送的端口号
	...
	public MailSender(String user, String password) {
		...
		properties.put("mail.smtp.port", mailhostPort);
		properties.put("mail.smtp.socketFactory.port", mailhostPort);
...
//		message.setDataHandler(handler);
	...
	public void setMailhostPort(String mailhostPort) {
		...
		properties.put("mail.smtp.port", this.mailhostPort);
		properties.put("mail.smtp.socketFactory.port", this.mailhostPort);
	}
